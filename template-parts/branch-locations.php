...
?>
<section class="d-none d-md-block d-lg-block | desktop-branch-info">
<?php
/*if (isset($branch)) {
...
<section class="text-center py-5 d-none d-md-block d-lg-block | branch-locations">
    <div class="container">
        <h2 class="text-left locations__title d-md-block">
            <?php if (isset($branch)) : ?>
