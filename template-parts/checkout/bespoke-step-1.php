...
<main class="checkout__wrapper cash01__section" id="addressLookup">
        ...
        <div class="container form__section">
            ...
            <div class="row mb-3 form__body lightblue__box">
                <div class="col-12">
                    <form method="post" id="formstep1" action="/checkout/<?php echo $type; ?>/complete">
                    <div class="row no-gutters pr-md-5 pt-5">
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 mb-3 px-0 d-flex align-items-end">
                                    <!--<a class="btn btn-default book__button" href="/cash-02">Book Your Appointment</a>-->
                                    <button class="btn btn-default book__button" type="submit">Temporarily Reserve this Car</button>
                                </div>
                            </div>
                        </div>
                    </div>
